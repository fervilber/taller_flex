...
Para que la variable reaccione en la app, hay que insertarla dentro de una output, que indica objetos que dibuja el servidor y que están relacionados intimamente con tipos de salida de R.

![render](https://bookdown.org/weicheng/shinyTutorial/images/outputs.png)

---

# PRÁCTICA 4

## Insertar inputs y output

- creamos una aplicacion para imagenes
- creamos una aplicacion sobre un mapa leaflet 
...
- para app sin Shiny
 - mandar html
 - RPubs
- <ShinyApps.io> es la opción más sencilla. 5 app gratis!!!
- <aws> Instalar y [crear tu propio servidor Gratis en AWS](https://enrdados.netlify.com/post/instalar-r-shiny-en-aws/)   
- crear tu servidor en casa
- otras muchas opciones de pago en RSTUDIOcloud etc..
